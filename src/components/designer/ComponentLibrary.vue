<template>
  <div class="component-library">
    ...
    <a-collapse v-model:activeKey="activeGroups" :bordered="false" ghost>
      <a-collapse-panel
      ...
      >
        <div
          :ref="el => initSortable(el as HTMLElement | null, group.items)"
          class="library-list"
        >
          <div
...
import type { ComponentLibraryItem, ComponentType } from '@/types/antd-mapping'

const activeGroups = ref<string[]>([...COMPONENT_GROUP_ORDER])
...
const initSortable = (el: HTMLElement | null, _items: ComponentLibraryItem[]) => {
  if (!el) return
...
.component-library :deep(.ant-collapse) {
  flex: 1;
  overflow-y: auto;
  overflow-x: hidden;
}
.component-library :deep(.ant-collapse-header) {
